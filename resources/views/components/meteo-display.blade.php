    <div class="@if($partOfDay == 'matin')
                ...
                @endif
                min-w-[14rem] w-full max-w-[24rem] h-40 rounded-lg shadow-md overflow-hidden relative mx-auto">
        ...
        <div class="absolute w-full h-full z-20">
            <img class="object-contain object-top bottom-0 h-full w-full -translate-y-1/4 opacity-80" src="{{ asset('images/weather/clouds.png') }}" alt="" style="">
        </div>
        ...
        <div class="relative w-full h-full p-3 pl-6 grid">
            <p class="z-50 text-5xl my-4 font-bold drop-shadow-lg @if(!$weather->isDay) text-white @else text-slate-700 @endif">{{ $time }}</p>
